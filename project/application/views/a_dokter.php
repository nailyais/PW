            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $row->hari_hadir;?></td>
                  <td><?php echo $row->jam_buka;?></td>
                  <td><?php echo $row->jam_tutup;?></td>
                  <td><?php echo $row->deskripsi;?></td>
                  <td>
                    <div class="btn-group">
                      <a href="<?php echo base_url();?>admin/editdokter/<?php echo $row->id_dokter;?>"><button type="button" class="btn btn-info">Edit</button></a>
                      <a href="<?php echo base_url();?>crud/deletedokter/<?php echo $row->id_dokter;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                    </div></td>
                </tr>
                <?php endforeach;?>
                </tbody>
